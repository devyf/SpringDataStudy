...
/**
 * @Description: 工具类:单例模式/静态单例模式  静态方法
 * @Author: huang
 * @Date: 2021/5/14 12:13
 */
public class JPAUtil {
    ...
    static{
        try {
            entityManagerFactory = Persistence.createEntityManagerFactory("com.fengye.jpa01");
        } catch (Exception e) {
            e.printStackTrace();
